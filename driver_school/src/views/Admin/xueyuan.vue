<template>
  <div>
    ...
    <el-table-column prop="planA" label="科一成绩" width="120">
    </el-table-column>
    <el-table-column prop="planB" label="科二成绩" width="120">
    </el-table-column>
    <el-table-column prop="planC" label="科三成绩" width="120">
    </el-table-column>
    <el-table-column prop="planD" label="科四成绩" width="120">
    </el-table-column>
...
export default {
  ...
  methods: {
    ...
    const res = await this.$http.get(
      `/student/stu-page?keyword=&pageSize=${val}&pageNum=1`
    );
  ...
  async handleCurrentChange(val) {
    const res = await this.$http.get(
      `/student/stu-page?keyword=&pageSize=${this.pageSize}&pageNum=${val}`
    );
